...
CarPaths = [
    [(1650, 490,pi, []),
        (1420,490,pi,[44,33]),
        (1335,490,pi, [44,33]), #turning right
        (1295,450,pi/2, []),
        (1295,300,pi/2,[39,37]),
        (1295,200,pi/2, [39,37]),
        (1295,140,pi/2, []),  #turning
        (1255,100,pi, []),
        (880,100,pi, []), #turning
        (840,60,pi/2, []),
        (840,-50,pi/2, [])],
    [(850,850,pi/2, []),
        ...
        (810,485,pi, []),
        (730,485,pi, [22,23]),
        (660,485,pi, [22,23]), #turning
        (620,445,pi/2, []),
        (620,270,pi/2, [2,4]),
        (620,200,pi/2, [2,4]), #turning
        (660,160,0, []),
        (1200,160,0, []),  #turning
        (1240,200,-pi/2, [37,39]),
        (1240,300,-pi/2, [37,39]),
